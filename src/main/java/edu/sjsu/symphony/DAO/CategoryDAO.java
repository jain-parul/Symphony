...
public class CategoryDAO {
	...
	public List<String> getAlbumItemRecoList(String productId){
		Connection db=new DBConnection("mysql").getmysqlDBConnection();
		PreparedStatement stmt=null;
		ResultSet result=null;
		
		List<String> itemIdList=new ArrayList<String>();
		String query="select Album_Item_reco from Album_Item_Reco where Album_ItemId = "+productId;
		try {
			stmt=db.prepareStatement(query);
			result=stmt.executeQuery();
			while(result.next())
				itemIdList.add(result.getString("Album_Item_reco"));
			return itemIdList;
		} catch (SQLException e) {
			e.printStackTrace();
			return null;
	...
	public List<String> getTrackItemRecoList(String productId){
		Connection db=new DBConnection("mysql").getmysqlDBConnection();
		PreparedStatement stmt=null;
		ResultSet result=null;
		
		List<String> itemIdList=new ArrayList<String>();
		String query="select Track_Item_reco from Track_Item_Reco where Track_Item_Id = "+productId;
		try {
			stmt=db.prepareStatement(query);
			result=stmt.executeQuery();
			while(result.next())
				itemIdList.add(result.getString("Track_Item_reco"));
			return itemIdList;
		} catch (SQLException e) {
			e.printStackTrace();
			return null;
	...
	public List<String> getArtistItemRecoList(String productId){
		Connection db=new DBConnection("mysql").getmysqlDBConnection();
		PreparedStatement stmt=null;
		ResultSet result=null;
		...
		String query="select Artist_Item_reco from Artist_Item_Reco where Artist_Item_id = "+productId;
		try {
			stmt=db.prepareStatement(query);
			result=stmt.executeQuery();
			while(result.next())
				itemIdList.add(result.getString("Artist_Item_reco"));
			return itemIdList;
		} catch (SQLException e) {
			e.printStackTrace();
			return null;
